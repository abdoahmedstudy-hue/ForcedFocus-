...
class TestDaemonRefactor(unittest.TestCase):
    def setUp(self):
        ...
        with patch('os.geteuid', return_value=0), \
             patch('forcefocus_daemon.ForcedFocusDaemon._load_settings', return_value={}), \
    ...
    def test_start_session_blacklist(self, mock_atomic_write, mock_enforce, mock_load_lists):
        ...
        self.assertTrue(any("active_domains" in call.args[1] for call in mock_atomic_write.call_args_list))
    ...
    def test_restore_session_backward_compatibility(self):
        ...
        with patch('forcefocus_daemon.ForcedFocusDaemon._enforce_block'), \
    ...
    def test_restore_session_empty_list(self):
        ...
        with patch('forcefocus_daemon.ForcedFocusDaemon._enforce_whitelist'), \
             patch('forcefocus_daemon.get_continuous_time', return_value=100.0):
            self.daemon._restore_session()
