...
class TestDaemonNaming(unittest.TestCase):
    ...
    def test_init_naming(self):
        ...
        self.assertTrue(hasattr(self.daemon, 'active_domains'), "active_domains attribute should exist")
        self.assertFalse(hasattr(self.daemon, 'blocked_domains'), "blocked_domains attribute should not exist")
