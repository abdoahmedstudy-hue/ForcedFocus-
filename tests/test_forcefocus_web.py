...
class TestForceFocusWeb(unittest.TestCase):
    ...
    def test_send_to_daemon_success(self, mock_socket):
        ...
        mock_sock_inst.recv.side_effect = [b'{"status": "ok", "message": "success"}', b'']
    ...
    def test_send_to_daemon_connection_refused_retry(self, mock_socket, mock_sleep):
        ...
        mock_socket.side_effect = [ConnectionRefusedError("Connection refused"), FileNotFoundError("No socket"), mock_sock_inst]
...
class TestForcedFocusHandler(unittest.TestCase):
    ...
    def test_is_origin_allowed(self):
        ...
        handler = forcefocus_web.ForcedFocusHandler.__new__(forcefocus_web.ForcedFocusHandler)
        handler.headers = {}
    ...
    def test_do_POST_api_start(self, mock_read_body, mock_send_json, mock_send_to_daemon):
        handler = forcefocus_web.ForcedFocusHandler.__new__(forcefocus_web.ForcedFocusHandler)
    ...
    @patch('forcefocus_web.ForcedFocusHandler._send_json')
    @patch('forcefocus_web.ForcedFocusHandler._read_body')
    def test_do_POST_api_lists_bulk(self, mock_read_body, mock_send_json, mock_send_to_daemon):
        handler = forcefocus_web.ForcedFocusHandler.__new__(forcefocus_web.ForcedFocusHandler)
